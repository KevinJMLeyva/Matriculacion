...
if (newfile.is_open()){
  ...
  while(opc!="8"){ ///Menú de 8 opciones, bueno 7 si no contamos el salir
    ...
    if(opc=="1"){
     ...
     //modificar un alumno con su número de lista, primero se debe ordenar
      ...
      //ordena a los alumnos, después muestra las matrículas
      alumnos.ordena();
      ...
      //Ordenas los alumnos y guarda las matrículas en un archivo de texto, se puede elegir la dirección del archivo de texto
      alumnos.ordena();
